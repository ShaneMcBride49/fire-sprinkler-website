...
export default function HomePage() {
  return (
    <div className="min-h-screen">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <Link
                  ...
                  className={buttonVariants({ size: "lg", className: "text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6" })}
                >
                  Get a Quote
                ...
                <Link
                  ...
                  className={buttonVariants({ 
                    variant: "outline", 
                    size: "lg", 
                    className: "text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 border-white/20 text-white hover:bg-white hover:text-slate-900" 
                  })}
                >
      ...
      {/* Resources Callout */}
      <section id="resources" className="py-16 sm:py-24 relative overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center text-white">
          <h2 className="text-2xl font-bold tracking-tight sm:text-3xl lg:text-4xl mb-4 sm:mb-6">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-2 text-sm sm:text-base">Quick turnaround to meet tight construction timelines</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">We work efficiently to keep your project on schedule without compromising safety standards.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-2 text-sm sm:text-base">Seamless integration with existing sprinkler systems</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">Our expertise ensures new installations work perfectly with your current fire protection infrastructure.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-2 text-sm sm:text-base">Coordination with general contractors and trades</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">We work closely with your construction team to ensure smooth project execution and minimal disruptions.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold">Decades of mid-rise hotel and commercial experience</h3>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold">Competitive pricing without cutting corners</h3>
              <p className="text-muted-foreground text-sm sm:text-base">
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold">Clear communication and consistent job site presence</h3>
              <p className="text-muted-foreground text-sm sm:text-base">
